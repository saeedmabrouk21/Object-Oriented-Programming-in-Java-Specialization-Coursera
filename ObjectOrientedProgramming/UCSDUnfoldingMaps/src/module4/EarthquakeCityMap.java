...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		int x = 50;
		int y = 125;
		triangle(x-3, y-3,x+6,y+6,x-12,y+6);
	...
	private void printQuakes() 
	{
		...
		for (Marker  cm : countryMarkers) {
			...
			for(Marker mark : quakeMarkers) {
				//System.out.println(mark.getProperties());
				if(mark.getProperties().containsKey("country")&& mark.getProperty("country").equals(name)) {
					num++;
					totalWaterQuakes--;
				}
		...
		System.out.println("Ocean : "+totalWaterQuakes);
